...
#if defined (MBED_CONF_EASY_CONNECT_WIFI_ESP8266_DEBUG) \
    && defined (MBED_CONF_EASY_CONNECT_WIFI_ESP8266_RTS) \
    && defined (MBED_CONF_EASY_CONNECT_WIFI_ESP8266_CTS)
ESP8266Interface wifi(MBED_CONF_EASY_CONNECT_WIFI_ESP8266_TX,
        MBED_CONF_EASY_CONNECT_WIFI_ESP8266_RX,
        MBED_CONF_EASY_CONNECT_WIFI_ESP8266_DEBUG,
        MBED_CONF_EASY_CONNECT_WIFI_ESP8266_RTS,
        MBED_CONF_EASY_CONNECT_WIFI_ESP8266_CTS);
#elif defined (MBED_CONF_EASY_CONNECT_WIFI_ESP8266_RTS) \
    && defined (MBED_CONF_EASY_CONNECT_WIFI_ESP8266_CTS)
ESP8266Interface wifi(MBED_CONF_EASY_CONNECT_WIFI_ESP8266_TX,
        MBED_CONF_EASY_CONNECT_WIFI_ESP8266_RX,
        false,
        MBED_CONF_EASY_CONNECT_WIFI_ESP8266_RTS,
        MBED_CONF_EASY_CONNECT_WIFI_ESP8266_CTS);
#elif defined (MBED_CONF_EASY_CONNECT_WIFI_ESP8266_DEBUG)
ESP8266Interface wifi(MBED_CONF_EASY_CONNECT_WIFI_ESP8266_TX,
        MBED_CONF_EASY_CONNECT_WIFI_ESP8266_RX,
        MBED_CONF_EASY_CONNECT_WIFI_ESP8266_DEBUG);
#else
