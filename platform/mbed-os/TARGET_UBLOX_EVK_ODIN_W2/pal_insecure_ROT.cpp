...
{
#warning message ("UBLOX ODIN doesn't have secure Root of Trust, You are using insecure Root Of Trust implementation, DO NOT USE IN PRODUCTION ENVIRONMENTS. REPLACE WITH A PROPER IMPLEMENTATION BEFORE USE")
    PAL_LOG(WARN, "You are using unsecure Root Of Trust implementation");
